...
const deviceData = {
  "iPhone 8": {
    storage: [64, 128, 256],
    basePrice: { 64: 300, 128: 350, 256: 400 },
  },
  "iPhone 8 Plus": {
    storage: [64, 128, 256],
    basePrice: { 64: 400, 128: 450, 256: 500 },
  },
  ...
  "iPhone XR": {
    storage: [64, 128, 256],
    basePrice: { 64: 450, 128: 500, 256: 550 },
  },
  "iPhone 11": {
    storage: [64, 128, 256],
    basePrice: { 64: 500, 128: 550, 256: 600 },
  },
  "iPhone 11 Pro": {
    storage: [64, 256, 512],
    basePrice: { 64: 700, 256: 800, 512: 900 },
  },
  "iPhone 11 Pro Max": {
    storage: [64, 256, 512],
    basePrice: { 64: 800, 256: 900, 512: 1000 },
  },
  "iPhone 12": {
    storage: [64, 128, 256],
    basePrice: { 64: 600, 128: 650, 256: 700 },
  },
  "iPhone 12 Pro": {
    storage: [128, 256, 512],
    basePrice: { 128: 800, 256: 900, 512: 1000 },
  },
  "iPhone 12 Pro Max": {
    storage: [128, 256, 512],
    basePrice: { 128: 900, 256: 1000, 512: 1100 },
  },
  "iPhone 13": {
    storage: [128, 256, 512],
    basePrice: { 128: 650, 256: 700, 512: 800 },
  },
  "iPhone 13 Pro": {
    storage: [128, 256, 512, 1024],
    basePrice: { 128: 850, 256: 950, 512: 1050, 1024: 1150 },
  },
  "iPhone 13 Pro Max": {
    storage: [128, 256, 512, 1024],
    basePrice: { 128: 950, 256: 1050, 512: 1150, 1024: 1250 },
  },
  "iPhone 14": {
    storage: [128, 256, 512],
    basePrice: { 128: 700, 256: 750, 512: 850 },
  },
  "iPhone 14 Pro": {
    storage: [128, 256, 512, 1024],
    basePrice: { 128: 900, 256: 1000, 512: 1100, 1024: 1200 },
  },
  "iPhone 14 Pro Max": {
    storage: [128, 256, 512, 1024],
    basePrice: { 128: 1000, 256: 1100, 512: 1200, 1024: 1300 },
  },
  "iPhone 15": {
    storage: [128, 256, 512],
    basePrice: { 128: 750, 256: 800, 512: 900 },
  },
  "iPhone 15 Pro": {
    storage: [128, 256, 512, 1024],
    basePrice: { 128: 950, 256: 1050, 512: 1150, 1024: 1250 },
  ...
  "iPhone 15 Pro Max": {
    ...
    basePrice: { 256: 1150, 512: 1250, 1024: 1350 },
  },
  "iPhone 16": {
    storage: [128, 256, 512],
    basePrice: { 128: 800, 256: 850, 512: 950 },
  },
  "iPhone 16 Pro": {
    storage: [256, 512, 1024],
    basePrice: { 256: 1100, 512: 1200, 1024: 1300 },
  },
  "iPhone 16 Pro Max": {
    storage: [256, 512, 1024],
    basePrice: { 256: 1200, 512: 1300, 1024: 1400 },
  },
};
